    ...
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!req.files || Object.keys(req.files).length === 0) {
                ...
                const createProdutcService = new CreateProductService_1.CreateProductService;
                const product = yield createProdutcService.execute({
                    name, price, description, banner: resultFile.url, category_id
                });
